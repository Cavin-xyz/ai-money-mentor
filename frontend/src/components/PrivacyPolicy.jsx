const SECTIONS = [
  ['1. Overview', 'FinMind provides financial planning tools — FIRE Planner, Money Health Score, Tax Wizard, Life Event Advisor, Couple\'s Planner, Portfolio X-Ray and Scam Shield. Everything runs on the computer where the app is installed: the AI model, the knowledge base and your saved data.'],
